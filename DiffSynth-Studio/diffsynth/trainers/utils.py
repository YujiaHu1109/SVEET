...
class DiffusionTrainingModule(torch.nn.Module):
    ...
    def switch_pipe_to_training_mode(
        ...
        if lora_base_model is not None:
            for base_model in lora_base_model.split(","):
    ...
    for epoch_id in range(num_epochs):
        for step_in_epoch,data in enumerate(tqdm(dataloader)):
            with accelerator.accumulate(model):
                ...
                if step_in_epoch % 10 == 0 and grad_norm is not None:
                    print(f"[Step {step_in_epoch}] loss={loss.item():.4f}, "
                        f"grad_norm={grad_norm.item():.4f} (max=0.5)")
                # ===========================================
...
def wan_parser():
    ...
    ### Newly added for cm ###
    parser.add_argument("--training_mode", type=str, default="consistency_distillation", help="training_mode")
    parser.add_argument("--target_ema_mode", type=str, default="fixed", help="target_ema_mode")
    parser.add_argument("--start_ema", type=float, default=0.95, help="start_ema")
    parser.add_argument("--scale_mode", type=str, default="fixed", help="scale_mode")
    parser.add_argument("--start_scales", type=int, default=40, help="start_scales")
    parser.add_argument("--end_scales", type=int, default=40, help="end_scales")
    parser.add_argument("--total_training_steps", type=int, default=600000, help="total_training_steps")
    parser.add_argument("--loss_norm", type=str, default="l2", help="loss_norm")
    parser.add_argument("--lr_anneal_steps", type=int, default=0, help="lr_anneal_steps")
    parser.add_argument("--use_scale_shift_norm", type=bool, default=False, help="use_scale_shift_norm")
    parser.add_argument("--dropout", type=float, default=0.0, help="dropout")
    parser.add_argument("--teacher_dropout", type=float, default=0.0, help="teacher_dropout")
    parser.add_argument("--ema_rate", type=str, default="0.999,0.9999,0.9999432189950708",  help="ema_rate")
    parser.add_argument("--global_batch_size", type=int, default=256, help="global_batch_size")
    parser.add_argument("--lr", type=float, default=0.000008, help="lr")
    parser.add_argument("--weight_decay", type=float, default=0.0, help="weight_decay")
    parser.add_argument("--weight_schedule", type=str, default="uniform", help="weight_schedule")
    parser.add_argument("--distill_steps_per_iter", type=int, default=50000, help="distill_steps_per_iter")
    parser.add_argument("--schedule_sampler", type=str, default="uniform", help="schedule_sampler")
    parser.add_argument("--data_dir", type=str, default="imagenet100", help="data_dir")
    parser.add_argument("--microbatch", type=int, default=0, help="microbatch")
    parser.add_argument("--resume_checkpoint", type=str, default="", help="resume_checkpoint")
    parser.add_argument("--log_interval", type=int, default=10, help="log_interval")
    parser.add_argument("--save_interval", type=int, default=200, help="save_interval")
    parser.add_argument("--global_step", type=int, default=100000, help="global_step")
    parser.add_argument("--use_fp16", type=bool, default=False, help="use_fp16")
    parser.add_argument("--fp16_scale_growth", type=float, default=1e-3, help="fp16_scale_growth")
