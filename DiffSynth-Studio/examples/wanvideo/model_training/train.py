...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        print(f"\n=== Loading Pi_perp from {pi_perp_path} ===")
...
if __name__ == "__main__":
    parser = wan_parser()
    parser.add_argument("--pi_perp_path", type=str, required=True,
                        help="Path to the Pi_perp artifact produced by tools/feature_or.py")
    ...
    model = WanTrainingModule(
        ...
        pi_perp_path=args.pi_perp_path,
